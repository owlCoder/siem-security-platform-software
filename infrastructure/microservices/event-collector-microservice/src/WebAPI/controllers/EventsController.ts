...
import {
    ...
    validateEventIdsArrayBody,
    validateEventRangeParams,
...
export class EventsController {
    ...
    private initializeRoutes(): void {
        ...
        this.router.get("/events/:id", validateEventIdParam, this.getEventById.bind(this));
        this.router.get("/events/from/:fromId/to/:toId", validateEventRangeParams, this.getEventsFromId1ToId2.bind(this))
        this.router.post("/events", validateEventBody, this.createEvent.bind(this));
        this.router.delete("/events/:id", validateEventIdParam, this.deleteEvent.bind(this));
        this.router.delete("/events/old", validateEventIdsArrayBody, this.deleteOldEvents.bind(this));
    }
