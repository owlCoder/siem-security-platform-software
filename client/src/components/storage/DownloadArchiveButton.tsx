...
import { DownloadArchiveProps } from "../../types/props/storage/DownloadArchiveProps";


export default function DownloadArchiveButton({ archiveId, fileName, storageApi }: DownloadArchiveProps) {
    const { token } = useAuth();
