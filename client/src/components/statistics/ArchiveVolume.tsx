        ...
        <div className="flex flex-col gap-4 w-full p-4!">
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    <button
                        className={`px-5! py-2! rounded-[10px]! text-white text-sm font-semibold transition-all duration-200 ${period === "daily" ? "bg-[#007a55]" : "bg-[#313338]"
                            }`}
                        onClick={() => onPeriodChange("daily")}>
                        Daily
                    </button>
                    <button
                        className={`px-5! py-2! rounded-[10px]! text-white text-sm font-semibold transition-all duration-200 ${period === "monthly" ? "bg-[#007a55]" : "bg-[#313338]"
                            }`}
                        onClick={() => onPeriodChange("monthly")}>
                        Monthly
                    </button>
                    <button
                        className={`px-5! py-2! rounded-[10px]! text-white text-sm font-semibold transition-all duration-200 ${period === "yearly" ? "bg-[#007a55]" : "bg-[#313338]"
                            }`}
